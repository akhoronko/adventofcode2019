...
def run():
    ...
    print(points)
    x_offset = -1 * min(x_delta for x_delta, y_delta in points)
    x_size = x_offset + max(x_delta for x_delta, y_delta in points) + 1
    y_offset = -1 * min(y_delta for x_delta, y_delta in points)
    y_size = y_offset + max(y_delta for x_delta, y_delta in points) + 1
